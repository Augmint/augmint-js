...
export class TokenAEur_ABI_2ea91d34a7bfefc8f38ef0e8a5ae24a5 extends Contract {
    ...
    methods: {
        ...
        decreaseApproval(_spender: string, _subtractedValue: number | string): TransactionObject<void>;
        ...
        setSymbol(_symbol: string): TransactionObject<void>;

        setName(_name: string): TransactionObject<void>;
        ...
        increaseApproval(_spender: string, _addedValue: number | string): TransactionObject<void>;
