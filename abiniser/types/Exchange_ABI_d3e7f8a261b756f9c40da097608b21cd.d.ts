...
export class Exchange_ABI_d3e7f8a261b756f9c40da097608b21cd extends Contract {
    ...
    methods: {
        ...
        getActiveBuyOrders(offset: number | string, chunkSize: number | string): TransactionObject<((string)[])[]>;

        getActiveSellOrders(offset: number | string, chunkSize: number | string): TransactionObject<((string)[])[]>;
