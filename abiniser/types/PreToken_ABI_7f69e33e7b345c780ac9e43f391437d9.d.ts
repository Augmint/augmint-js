...
export class PreToken_ABI_7f69e33e7b345c780ac9e43f391437d9 extends Contract {
    ...
    methods: {
        ...
        getAgreements(offset: number | string, chunkSize: number | string): TransactionObject<((string)[])[]>;
