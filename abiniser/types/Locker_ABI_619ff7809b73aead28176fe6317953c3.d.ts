...
export class Locker_ABI_619ff7809b73aead28176fe6317953c3 extends Contract {
    ...
    methods: {
        ...
        getLockProducts(offset: number | string): TransactionObject<((string)[])[]>;

        getLockCountForAddress(lockOwner: string): TransactionObject<string>;

        getLocks(offset: number | string): TransactionObject<((string)[])[]>;

        getLocksForAddress(lockOwner: string, offset: number | string): TransactionObject<((string)[])[]>;
